...
#
# Version 8.32: 2021-10-04 ready-for.sh
#   - Update LFS254
#   - Add aarch64 and riscv to arch lists
#   - Allow Linux support when OS contains Linux
#   - If cm tarballs are updated, move them out of the way and redownload
# 
#===============================================================================
VERSION=8.32
...
usage() {
    ...
    echo "  -f  --fix-missing          Skip uninstallable packages"
...
FALLBACK=(
    ...
    [Ubuntu-21.04]="Ubuntu-20.04 Ubuntu Debian-11 Debian"
...
DISTRO_ALIASES=(
    ...
    [Ubuntu-21.10-]="Ubuntu-12.04 Ubuntu-12.10 Ubuntu-13.04 Ubuntu-13.10 Ubuntu-14.04 Ubuntu-14.10 Ubuntu-15.04 Ubuntu-15.10 Ubuntu-16.04 Ubuntu-16.10 Ubuntu-17.04 Ubuntu-17.10 Ubuntu-18.10 Ubuntu-19.04 Ubuntu-19.10 Ubuntu-20.10 Ubuntu-21.04 Ubuntu-21.10"
)
...
DISTRO_ARCH=
DISTRO_BL="CentOS-6- Debian-8- Fedora-32- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL-6- SLES-12.2- Ubuntu-19.10- Ubuntu-20.10"
DISTRO_BL[EMBEDDED]="CentOS-7- Debian-9- 5 Fedora-32- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL SLES Ubuntu-18.04 Ubuntu-19.10- Ubuntu-20.10"
...
PACKAGES[Debian-11_@kdump]="-kdump-tools"
...
SUGGESTS[Debian_@kernel]="libglade2-dev libgtk2.0-dev libslang2-dev qt5-default"
PACKAGES[Debian-9_@kernel]="-libncurses-dev libncurses5-dev -libhugetlbfs-dev"
...
RECOMMENDS[Ubuntu_@kernel]="hugepages"
RECOMMENDS[Ubuntu-20.04_@kernel]="-hugepages"
#-------------------------------------------------------------------------------
...
RECOMMENDS[RHEL-8_@kernel]="-sparse"
RECOMMENDS[Fedora_@kernel]="qt5-devel"
RECOMMENDS[Fedora-33_@kernel]="-qt5-devel qt-devel"
RECOMMENDS[Fedora-999_@kernel]="-qt5-devel qt-devel"
...
RECOMMENDS[Debian_@perf]="libaio-dev libnuma-dev libperl-dev libpython-dev libpython3-dev"
SUGGESTS[Debian_@perf]="libgtk2.0-dev"
RECOMMENDS[Ubuntu-20.04_@perf]="-libpython-dev"
#-------------------------------------------------------------------------------
...
RECOMMENDS[RHEL_@perf]="libaio-devel perl-devel platform-python-devel"
SUGGESTS[RHEL_@perf]="gtk2-devel"
RECOMMENDS[RHEL-7_@perf]="-platform-python-devel"
PACKAGES[RHEL-8_@perf]="-libzstd-devel"
RECOMMENDS[Fedora_@perf]="[RHEL-7_@perf]"
#-------------------------------------------------------------------------------
...
RECOMMENDS[openSUSE_@perf]="libaio-devel libnuma-devel python-devel"
...
PACKAGES[Ubuntu-18.04_@qemu]="libpython-dev"
PACKAGES[Ubuntu-20.04_@qemu]="-"
PACKAGES[LinuxMint-20.1_@qemu]="libglib2.0-dev libpixman-1-dev"
PACKAGES[RHEL_@qemu]="glib2-devel pixman-devel python-devel SDL2-devel zlib-devel"
PACKAGES[RHEL-8_@qemu]="-python-devel"
...
PACKAGES[Ubuntu-21.04_@virt]="-qemu-kvm"
...
#-------------------------------------------------------------------------------
PACKAGES[LFD440]="[LFD420] @ebpf @kdump"
...
PACKAGES[Ubuntu_LFD460]="daemon gcc-multilib libarchive-dev libegl1-mesa
	...
	python-sqlite libsdl2-dev python3 python3-progressbar python3-subunit
	sqlite3 xsltproc"
...
PACKAGES[Ubuntu-21.04_LFD460]="[Ubuntu-20.04_LFD460] -python-sqlite"
PACKAGES[Debian-9_LFD460]="libnfs8"
PACKAGES[Debian-10_LFD460]="libnfs12"
PACKAGES[Debian-11_LFD460]="libnfs13 -pylint3 pylint -python-sqlite"
PACKAGES[RHEL_LFD460]="cpp daemonize diffutils libarchive-devel mesa-libGL-devel
	...
	rpcgen perl tar SDL-devel sqlite which xz"
...
PACKAGES[Fedora_LFD460]="cpp diffutils findutils
	...
	python3-pip python3-ply python3-subunit SDL-devel which"
PACKAGES[Fedora-999_LFD460]="-SDL-devel"
PACKAGES[openSUSE_LFD460]="libarchive-devel libnfs8 libSDL-devel Mesa-dri-devel
	...
	python-curses python-xml which"
...
PACKAGES[Ubuntu-20.04_LFS426]="-hugepages -libncurses5-dev libncurses-dev"
...
check_ram() {
    ...
    if [[ -z $RAM_GBYTES ]] ; then
        ...
        fail "Only $RAM_GBYTES GiB RAM (you require at least $RAM GiB of RAM)"
    else
...
get_activity_tarball() {
    ...
    if [[ -f $TODIR/$FILE ]] ; then
        ...
        if [[ -n $SIMULATE_FAILURE ]] || ! tar -t -f "$TODIR/$FILE" >/dev/null 2>&1 ; then
            ...
            warn "$FILE failed md5sum check. Rename and redownload..."
            mv -v "$TODIR/$FILE" "$TODIR/$FILE.1"
        fi
    else
